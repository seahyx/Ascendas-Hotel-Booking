// To parse this data:
//
//   import { Convert, IDHotel } from "./file";
//
//   const iDHotel = Convert.toIDHotel(json);
//
...
export class Convert {
    public static toIDHotel(json: string): IDHotel {
        return cast(JSON.parse(json), r("IDHotel"));
    }

    public static iDHotelToJson(value: IDHotel): string {
        return JSON.stringify(uncast(value, r("IDHotel")), null, 2);
    }
}
...
const typeMap: any = {
    "IDHotel": o([
        ...
        { json: "amenities_ratings", js: "amenities_ratings", typ: a(r("AmenitiesRating")) },
        { json: "description", js: "description", typ: "" },
        { json: "amenities", js: "amenities", typ: m(true) },
        { json: "original_metadata", js: "original_metadata", typ: r("OriginalMetadata") },
        { json: "image_details", js: "image_details", typ: r("ImageDetails") },
        { json: "hires_image_index", js: "hires_image_index", typ: "" },
    ...
    "Categories": o([
        { json: "overall", js: "overall", typ: r("BusinessHotel") },
        { json: "lake_hotel", js: "lake_hotel", typ: r("BusinessHotel") },
        { json: "business_hotel", js: "business_hotel", typ: r("BusinessHotel") },
        { json: "city_hotel", js: "city_hotel", typ: r("BusinessHotel") },
    ], false),
    "BusinessHotel": o([
        { json: "name", js: "name", typ: "" },
        { json: "score", js: "score", typ: 0 },
    ...
    "Score": o([
        { json: "overall", js: "overall", typ: 0 },
        { json: "kaligo_overall", js: "kaligo_overall", typ: 3.14 },
        { json: "solo", js: "solo", typ: 0 },
        { json: "couple", js: "couple", typ: 0 },
        { json: "family", js: "family", typ: 0 },
        { json: "business", js: "business", typ: 0 },
    ], false),
};
